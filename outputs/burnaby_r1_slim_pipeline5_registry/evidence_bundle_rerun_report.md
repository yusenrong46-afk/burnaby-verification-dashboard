...
- `burnaby_r1_028` -> `verified` ready=True bundle=`bundle::burnaby_r1_028` gaps=none
- `burnaby_r1_029` -> `review_needed` ready=False bundle=`bundle::burnaby_r1_029` gaps=text_condition_not_supported
- `burnaby_r1_075` -> `verified` ready=True bundle=`bundle::burnaby_r1_075` gaps=none
- `burnaby_r1_076` -> `verified` ready=True bundle=`bundle::burnaby_r1_076` gaps=none
...
- `burnaby_r1_046` -> `rejected` ready=False bundle=`bundle::burnaby_r1_046` gaps=value_not_found_in_evidence, unit_not_found_in_evidence
- `burnaby_r1_093` -> `review_needed` ready=False bundle=`bundle::burnaby_r1_093` gaps=pipeline5_text_candidate_requires_review, applies_to_not_supported, operator_not_supported, rule_object_not_supported
