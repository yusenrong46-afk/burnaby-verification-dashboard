...
- `fix_candidate_or_rule_family_mapping`: 15
- `rerun_with_evidence_bundle`: 12
- `operator_review`: 9
- `scope_review`: 6
...
- `calgary_rcg_012` -> `fix_candidate_or_rule_family_mapping` / `medium`: Extraction flagged this candidate for review; investigate and correct it upstream before rerun. Check upstream_extraction_requested_review in page 396; section 352(4.1); evidence_id m4_pack_0006_ev_002. Evidence bundle is safe to rerun through the verifier. Semantic match: calgary_rcg_019 (score 0.71, blockers different_numeric_value).
- `calgary_rcg_252` -> `fix_candidate_or_rule_family_mapping` / `medium`: Extraction flagged this candidate for review; investigate and correct it upstream before rerun. Check upstream_extraction_requested_review, pipeline5_text_candidate_requires_review, enumerated_branch_condition_missing in page 1030; section 8(3); evidence_id v3_repair_pack_0028_ev_001. Suggested stronger evidence: m4_pack_0001_ev_002. Evidence bundle is safe to rerun through the verifier. Semantic match: calgary_rcg_019 (score 0.90, blockers none).
- `calgary_rcg_203` -> `fix_candidate_or_rule_family_mapping` / `medium`: Extraction flagged this candidate for review; investigate and correct it upstream before rerun. Check upstream_extraction_requested_review, pipeline5_text_candidate_requires_review, enumerated_branch_condition_missing in page 1022; section 8(4); evidence_id m4_pack_0997_ev_001. Suggested stronger evidence: m4_pack_0001_ev_002. Evidence bundle is safe to rerun through the verifier. Semantic match: calgary_rcg_019 (score 0.90, blockers none).
...
- `calgary_rcg_013` -> `fix_candidate_or_rule_family_mapping` / `medium`: Extraction flagged this candidate for review; investigate and correct it upstream before rerun. Check upstream_extraction_requested_review in page 396; section 352(4.1); evidence_id m4_pack_0006_ev_003. Evidence bundle is safe to rerun through the verifier. Semantic match: calgary_rcg_019 (score 0.97, blockers none).
...
- `calgary_rcg_011` -> `fix_candidate_or_rule_family_mapping` / `medium`: Extraction flagged this candidate for review; investigate and correct it upstream before rerun. Check upstream_extraction_requested_review in page 396; section 352(4.1); evidence_id m4_pack_0006_ev_001. Semantic match: calgary_rcg_220 (score 1.00, blockers none).
