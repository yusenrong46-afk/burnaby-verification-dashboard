...
- Retry candidates from evidence repair: 13
- Evidence intelligence safe bundle retries: 1
- Evidence rerun attempts: 13
...
- Rule graph nodes / edges: 407 / 1737
- Proof DAG sidecar entries: 101
- Cache hits / misses: 0 / 101
...
- Felt verified-rule CSV rows: 82

## Review Actions

- `retry_with_better_evidence`: 13
